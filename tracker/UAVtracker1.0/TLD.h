...
public:
  ...
  void processFrame(const cv::Mat& frame,const cv::Mat& img1,const cv::Mat& img2,
      BoundingBox& bbnext,bool& lastboxfound, bool tl,bool tk,FILE* bb_file);
  ...
  void detect(const cv::Mat& frame,bool lastboxfound,bool tk);
